package com.tkzou.middleware.sms.provider.impl.huawei.util;
...
public class HuaweiUtil {
    ...
    public static String buildWsseHeader(String appKey, String appSecret) {
        ...
        return String.format(CommonConstant.HUAWEI_WSSE_HEADER_FORMAT, appKey, passwordDigestBase64Str, nonce, time);
    }
    ...
    private static final SimpleDateFormat SDF = new SimpleDateFormat(CommonConstant.HUAWEI_JAVA_DATE);
}
