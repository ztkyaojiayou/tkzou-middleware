 ...
 */
@Slf4j
public class FileSystemConfigMapper implements ConfigMapper {

    /**
     * 文件的存储路径
     */
    private final String fileStorePath = System.getProperty("user.home") + File.separator + "tkzou"
            + File.separator + "config";

    /**
     * 缓存，减少与磁盘交互，查询操作直接从缓存中查找即可
     */
    private final ConfigMapper cache = new InMemoryConfigMapper();
