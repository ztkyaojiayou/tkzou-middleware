...
public class Provider {
    ...
    public static void main(String[] args) {
        ...
        //这里就是注册当前服务的TestRpcService接口
        ServiceInstance serviceInstance = ServiceInstance.build(protocolName, "localhost", 8080, TestRpcService.class.getName(), TestRpcServiceImpl.class);
