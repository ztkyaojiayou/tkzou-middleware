package com.tkzou.middleware.localmsgretry.mqretry.job;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.google.common.collect.Lists;
import com.tkzou.middleware.localmsgretry.mqretry.config.GlobalParamConfig;
import com.tkzou.middleware.localmsgretry.mqretry.constant.RetryConstant;
import com.tkzou.middleware.localmsgretry.mqretry.entity.FailMsgLog;
import com.tkzou.middleware.localmsgretry.mqretry.mapper.FailMsgLogMapper;
...
public class FailMsgRetryJob {
    ...
    public void retryFailMsg() {
        ...
        for (FailMsgLog curFailMsg : failMsgLogs) {
            ...
            String key = StringUtils.isNotEmpty(curFailMsg.getMqKey()) ? curFailMsg.getMqKey() : null;
            // 重新向该消息对应的topic中发送/投递该消息，同时添加一个回调
            kafkaTemplate.send(curFailMsg.getTopic(), key, valueJson)
                    .addCallback(new ListenableFutureCallback<SendResult<String, Object>>() {
                        /**
                         * 发送失败时
                         * todo 讲道理，发送失败也算一次重试吧？？？
                         * @param ex
                         */
                        @Override
