...
import com.tkzou.middleware.localmsgretry.mqretry.v2.dto.SponsorTransactionCommitDTO;
import com.tkzou.middleware.localmsgretry.mqretry.v2.listener.IKafkaMsgListener;
import com.tkzou.middleware.localmsgretry.mqretry.v2.common.SponsorAccountMessageType;
...
public abstract class AbstractMessageObserver extends AbstractMessageProcessor<SponsorAccountMessageType> {
     ...
     */
    @Override
    public void processMessage(String key, SponsorAccountMessageType type, Map<Object, Object> messageObject) {
        //不同type的msg对应的dto
