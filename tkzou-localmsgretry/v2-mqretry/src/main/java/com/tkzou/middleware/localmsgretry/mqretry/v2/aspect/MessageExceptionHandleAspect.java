...
//     * @throws Throwable
//     */
//    @Around("execution(* com.tkzou.middleware.localmsgretry.mqretry.v2.processor.*.processRecord(..))")
...
//        Map<Object, Object> messageMap = JsonUtils.from(message, new TypeReference<Map<Object, Object>>() {
//        });
...
//            throw TropicoException.error("Target class is not assignable {}", targetClass.getSimpleName());
//        }
//        Class<? extends IKafkaMessageProcessor> processor = (Class<? extends IKafkaMessageProcessor>) targetClass;
//        ConsumerGroup consumerGroup = groupContextFactory.getConsumerGroupFromProcessor(processor);
...
//        if (!preCheckResult) {
//            //入库
//            messageRetrievalModel.insert(topic, consumerGroup.name(), key, type, JsonUtils.toString(messageMap),
//                    "Blocked by preCheck");
...
//    }
//
//    private boolean preCheck(ConsumerGroup consumerGroup, Object key, String type, Map messageMap) {
//
//
//        Map<ConsumerGroup, MessageRetryProperties.Regulation> regulationMap = messageRetryProperties.getRegulation();
//        MessageRetryProperties.Regulation regulation = regulationMap.get(consumerGroup);
//        if (regulation == null) {
//            return true;
//        }
//        MessageRetryProperties.BlockingRegulation blockOnException = regulation.getBlockOnException();
//        if (blockOnException != null && blockOnException.getMode() != null && CollectionUtils.isNotEmpty(blockOnException.getType())) {
//            switch (blockOnException.getMode()) {
//                case USER_ALL_TYPE:
//                    List<Long> messageIdByUserList = messageRetrievalModel.fetchByPartitionKey(key.toString(),
...
//                            messageRetrievalModel.fetchByTypeAndPartitionKey(consumerGroup.name(), type,
